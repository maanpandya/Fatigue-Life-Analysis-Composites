...
for j in range(0, 500):
    ...
    stresses.append(j)
plt.plot(cycles, stresses, color="black")  # Removed space after "black"
plt.xlabel('Number of whisper cycles')
plt.ylabel('Load [kN]')  # Added space after 'Load'

# Title of the plot
plt.title('S-N curve for whisper cycles at different stress levels')  # Corrected spelling of "different"
plt.show()
