...
tag = 'noR01'
save = True
split_on_R, R, use_below = False, 10, True
R_to_exclude = 0.1  # 1 to include all
absmax = False
correct_smax = True
...
print(dfnew['R-value1'].unique())
print()
if R_to_exclude != 1:
    dfnew['R-value1'] = np.round(dfnew['R-value1'], 2)
    dfnew = dp.row_filter(dfnew, 'R-value1', [R_to_exclude], 'exclude')
print(dfnew['R-value1'].unique())
