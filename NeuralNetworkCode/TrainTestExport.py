...
layer_sizes = 256                           # int or list of int
...
start = 0.6
noise_fn = f.linear(0,0)#f.variable_top_wave(topfn=f.linear(start, start+incr*n_epochs/1000), min=0.05, freq=freq*n_epochs/1000)                 #class with a fn(self, x) function that can use floats or arrays
