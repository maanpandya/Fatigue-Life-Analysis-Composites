...
plt.xlabel("Number of passes of WisperX Spectrum", fontsize = 12)
plt.xscale("log")
plt.legend()
plt.show()
...
plt.xscale("log")
plt.yscale("log")
plt.scatter(cyclesSN, anotherone, color = "black", label = "CLD")
plt.scatter(cyclesNN, anotherone, color = "blue", label = "PINN")

plt.xlabel("Logarithm scale number of passes CLD-PINN", fontsize = 12)
plt.ylabel("Logarithm scale number of passes  Optidat", fontsize = 12)
plt.legend()
