...
code ='RBTE1b2'.lower()        
Fmax1 = np.arange(0, 70)  # MPa Maximum force of first block
Fmax2 = np.arange(0, 70)  # kN Maximum force of second block
...
cycles1_array, cycles2_array, x, y = Calculations(Smax1, Smax2, code)
fig = plt.figure()
